...
Write-Output "Create temporary directory if it doesn't exist."
if (-Not (Test-Path $TEMP_DIR)) {
    New-Item -Path $TEMP_DIR -ItemType Directory | Out-Null
}

# Extract the zip file into the temporary directory
Write-Output "Extract the zip file into the temporary directory."
Expand-Archive -Path $ZIP_FILE -DestinationPath $TEMP_DIR -Force

# Remove the original zip file
Write-Output "Remove the original zip file."
Remove-Item -Path $ZIP_FILE -Force

# Remove package.json and README.md if they exist in the plugin folder
Write-Output "Remove package.json and README.md if they exist in the plugin folder."
...
Write-Output "Repackage the contents into a new zip file."
Push-Location $TEMP_DIR
Compress-Archive -Path $PLUGIN_FOLDER -DestinationPath "..\$ZIP_FILE" -Force
Pop-Location

# Clean up temporary directory
Write-Output "SUCCESS! Clean up temporary directory."
